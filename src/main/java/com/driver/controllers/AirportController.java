...
public class AirportController {
    ...
    AirportService theAirportService = new AirportService();
    ...
    public String addAirport(@RequestBody Airport airport){
        ...
        theAirportService.addAirport(airport);
        return "SUCCESS";
    }
    ...
    public String getLargestAirportName(){
       ...
       return theAirportService.getLargestAirportName();
    }
    ...
    public double getShortestDurationOfPossibleBetweenTwoCities(@RequestParam("fromCity") City fromCity, @RequestParam("toCity")City toCity){
       ...
       return theAirportService.getShortestDurationOfPossibleBetweenTwoCities(fromCity, toCity);
    }
    ...
    public int getNumberOfPeopleOn(@PathVariable("date") Date date,@RequestParam("airportName")String airportName){
        ...
        return theAirportService.getNumberOfPeopleOn(date, airportName);
    }
    ...
    public int calculateFlightFare(@RequestParam("flightId")Integer flightId){
       ...
       return theAirportService.calculateFlightFare(flightId);
    ...
    public String bookATicket(@RequestParam("flightId")Integer flightId,@RequestParam("passengerId")Integer passengerId){
        ...
        return theAirportService.bookATicket(flightId, passengerId);
    }
    ...
    public String cancelATicket(@RequestParam("flightId")Integer flightId,@RequestParam("passengerId")Integer passengerId){
       ...
       return theAirportService.cancelATicket(flightId, passengerId);
    }
    ...
    public int countOfBookingsDoneByPassengerAllCombined(@PathVariable("passengerId")Integer passengerId){
       ...
       return theAirportService.countOfBookingsDoneByPassengerAllCombined(passengerId);
    }
    ...
    public String addFlight(@RequestBody Flight flight){
        ...
        theAirportService.addFlight(flight);
        return "SUCCESS";
    }
    ...
    public String getAirportNameFromFlightId(@PathVariable("flightId")Integer flightId){
        ...
        return theAirportService.getAirportNameFromFlightId(flightId);
    }
    ...
    public int calculateRevenueOfAFlight(@PathVariable("flightId")Integer flightId){
        ...
        return theAirportService.calculateRevenueOfAFlight(flightId);
    }
    ...
    public String addPassenger(@RequestBody Passenger passenger){
        ...
        theAirportService.addPassenger(passenger);
        return "SUCCESS";
    }
